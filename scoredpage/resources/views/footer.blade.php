            ...
            <div class="row">
                <div class="col-lg-6 pr-lg-5 mb-5">
                    <a href="index.html" class="navbar-brand">
                        <h1 class="mb-3 text-white"><span class="text-primary">Pasión</span> Scorts</h1>
                    </a>
                    ...
                    <div class="row">
                        <div class="col-sm-6 mb-5">
                            ...
                            <div class="d-flex flex-column justify-content-start">
                                ...
                                <a class="text-white-50 mb-2" href="about"><i class="fa fa-angle-right mr-2"></i>Nosotros</a>
                                <a class="text-white-50 mb-2" href="models"><i class="fa fa-angle-right mr-2"></i>Modelos</a>
                                <a class="text-white-50 mb-2" href="price"><i class="fa fa-angle-right mr-2"></i>Preguntas Frecuentes</a>
                                <a class="text-white-50" href="contact"><i class="fa fa-angle-right mr-2"></i>Contacto</a>
                            </div>
                        </div>
                        <div class="col-sm-6 mb-5">
